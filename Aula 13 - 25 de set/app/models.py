...
class PaginaPacientes(SQLModel):
    dados: list[PacientePublic]
    paginacao: MetadadosPaginacao
    
class PaginaEspecialidades(SQLModel):
    dados: list[EspecialidadePublic]
    paginacao: MetadadosPaginacao
    
class PaginaMedicos(SQLModel):
    dados: list[MedicoPublic]
    paginacao: MetadadosPaginacao
    
class PaginaConsultas(SQLModel):
    dados: list[ConsultaPublic]
    paginacao: MetadadosPaginacao